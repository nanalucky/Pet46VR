...
public var enableGroundCollision = true; //want this on except for the character controller demo test for VR
...
function Update () {
    ...
    if(enableGroundCollision) grounded=(collisionFlags & CollisionFlags.Below); //THIS SHIT WAS FUCKING UP THE COLLISION WITH THE GROUND SHIT YO
...
function OnTriggerEnter( other : Collider ) {
    ...
    function OnTriggerExit( other : Collider ) {
        ...
        function ActivateAutoWalk(){
            autowalk = 1;
        }

        function DeactivateAutoWalk(){
            autowalk = 0;
        }
