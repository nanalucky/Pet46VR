...
void surf (Input IN, inout SurfaceOutput o) {
	...
	o.Normal = UnpackNormal(tex2D(_EyeBump, float2((IN.uv_MainTex.x*_scleraSize)-((_scleraSize-1.0)/2.0),(IN.uv_MainTex.y*_scleraSize)-((_scleraSize-1.0)/2.0))));
	...
	half3 irisColTex = tex2D(_IrisColorTex,irUVc).rgb;
